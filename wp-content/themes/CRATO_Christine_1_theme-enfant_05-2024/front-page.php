...
?>
    ...
    <main id="primary" class="site-main">
        <section class="banner">
            ...
            <img class="bannerImg" src="<?php echo get_template_directory_uri() . '/assets/images/logo.png'; ?> " alt="logo Fleurs d'oranger & chats errants">
        </section>
        <section id="story" class="story">
            <h2><span class="TitleFade storyTitle">L'histoire</span></h2>
        ...
        <section id="studio" class="titleStudio">
            <h2><span class="TitleFade studioTitlte">Studio Koukaki</span></h2>
            <div>
